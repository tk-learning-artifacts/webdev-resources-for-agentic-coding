        ...
        <div className="container">
          ...
          {slide === "slide9" && (
            <section className="card">
              ...
              <p>Vercel makes it extremely easy to publish your GitHub projects to the internet for free.</p>
              <h3>How It Works</h3>
              <ul>
                <li>Connect your GitHub account to Vercel.</li>
                <li>Select a repository you want to deploy.</li>
                <li>Vercel automatically builds and hosts your project.</li>
                <li>Every Git push triggers an automatic redeploy.</li>
              </ul>
              <h3>Steps to Deploy</h3>
              <pre>{`1. Go to vercel.com
2. Click “Add New Project”
3. Import your GitHub repository
4. Configure build settings if needed (for most Vite apps defaults work)
5. Click Deploy

After deploying, Vercel provides a live URL you can share. Each push to the linked repo will create a new deployment.`}</pre>

              <div className="controls">
                <button className="secondary" onClick={() => setSlide("slide1")}>🏠 Home</button>
                <button className="secondary" onClick={() => setSlide("slide5")}>&larr; Back</button>
          ...
          {slide === "slideVSCode" && (
            <section className="card">
              ...
              <h3>Key Concepts</h3>
              <ul>
                <li><strong>Explorer:</strong> View and manage project files</li>
                <li><strong>Extensions:</strong> Add new tools and languages</li>
                <li><strong>Command Palette:</strong> Search all commands (Ctrl+Shift+P)</li>
                <li><strong>Integrated Terminal:</strong> Run commands inside the editor</li>
              </ul>
              <div className="controls">
                <button className="secondary" onClick={() => setSlide("slide1")}>🏠 Home</button>
                <button className="secondary" onClick={() => setSlide("slide1")}>&larr; Back</button>
                <button onClick={() => setSlide("slide2")}>Next →</button>
              </div>
            </section>
          )}
          ...
          {slide === "slide3" && (
            <section className="card">
              ...
              <div className="controls">
                <button className="secondary" onClick={() => setSlide("slide1")}>🏠 Home</button>
                <button className="secondary" onClick={() => setSlide("slide2")}>&larr; Back</button>
          ...
          {slide === "slide4" && (
            <section className="card">
              ...
              <div className="controls">
                <button className="secondary" onClick={() => setSlide("slide1")}>🏠 Home</button>
                <button className="secondary" onClick={() => setSlide("slide3")}>&larr; Back</button>
          ...
          {slide === "slide5" && (
            <section className="card">
              ...
              <div className="controls">
                <button className="secondary" onClick={() => setSlide("slide1")}>🏠 Home</button>
                <button className="secondary" onClick={() => setSlide("slide4")}>&larr; Back</button>
                <button onClick={() => setSlide("slide9")}>Next →</button>
              </div>
            </section>
          )}
          ...
          {slide === "slide7" && (
            <section className="card">
              ...
              <div className="controls">
                <button className="secondary" onClick={() => setSlide("slide1")}>🏠 Home</button>
                <button className="secondary" onClick={() => setSlide("slide6")}>&larr; Back</button>
